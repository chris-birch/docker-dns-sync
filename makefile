...
proto-build-technitium: # https://dev.to/davidsbond/golang-structuring-repositories-with-protocol-buffers-3012
	...
	--go_opt=module=github.com/chris-birch/docker-dns-sync/proto/technitium/${PROTO_VERSION} \
	--go-grpc_opt=module=github.com/chris-birch/docker-dns-sync/proto/technitium/${PROTO_VERSION} \
